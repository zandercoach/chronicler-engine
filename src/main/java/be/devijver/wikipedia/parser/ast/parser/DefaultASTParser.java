...
/**
 * Created by IntelliJ IDEA. User: steven Date: 5-nov-2006 Time: 17:00:52 To
...
public class DefaultASTParser extends AbstractASTParser {
  ...
  protected void doInvokeParseMethod(Content content, Visitor visitor, Object context) {
    try {
      Method method = getClass().getMethod("parse",
          new Class[] { content.getClass(), Visitor.class, context.getClass() });
      ...
      throw new ASTParseException("Error while handling AST object [" + content.toString() + "]: "
